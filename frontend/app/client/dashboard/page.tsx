import { getServices, getTopRatedProviders } from "@/lib/actions/client-actions";
    ...
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/35 bg-gradient-to-br from-blue-700 via-blue-800 to-slate-950 text-white">
        ...
        <div className="relative p-6 sm:p-10">
          ...
          <div className="mt-7 grid grid-cols-1 md:grid-cols-[1fr_1fr_auto] gap-3">
            <input
      ...
      <GlassCard className="p-5 sm:p-6">
        <SectionHeader
          ...
          description="Tap a service to see available professionals."
        />
      ...
      {/* Top Rated */}
      <ProvidersSection initialProviders={topProviders} services={services} />
    </div>
  );
}
