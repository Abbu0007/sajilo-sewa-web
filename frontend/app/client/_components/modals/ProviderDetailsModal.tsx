...
import { X, Heart, Mail, Phone, CalendarCheck } from "lucide-react";
            ...
            <div className="relative flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                {onToggleFavourite ? (
                  ...
                  >
                    <Heart className={cn("h-5 w-5", isFavourite ? "fill-red-500 text-red-500" : "text-white")} />
                  </button>
                ) : null}
          ...
          <div className="bg-white/10 border-t border-white/15 p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-white/15 bg-white/10 p-4">
                ...
                <div className="mt-1 text-white font-extrabold">{provider.phone ?? "Not provided"}</div>
              </div>
              ...
              <div className="rounded-2xl border border-white/15 bg-white/10 p-4">
                ...
                <div className="mt-1 text-white font-extrabold break-all">{provider.email ?? "Not provided"}</div>
              </div>
            </div>
